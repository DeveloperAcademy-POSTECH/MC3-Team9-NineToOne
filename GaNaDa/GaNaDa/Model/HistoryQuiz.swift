...
//MARK: 임시데이터 삭제예정
extension HistoryQuiz {
    static var preview: [HistoryQuiz] {
        return ([HistoryQuiz(quizID: 0,
                    question: "무엇이 맞을까요?",
                    type: .choice,
                    rightAnswer: "뵙겠습니다",
                    wrongAnswer: "봽겠습니다",
